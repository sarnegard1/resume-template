...
var G__44589 = o;
(G__44589[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__44598 = jsprops;
(G__44598["defaultValue"] = value);

(G__44598["onChange"] = ((function (G__44598,v,value,on_change){
return (function (p1__44595_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__44595_SHARP_);
});})(G__44598,v,value,on_change))
);

(G__44598["ref"] = ((function (G__44598,v,value,on_change){
return (function (p1__44596_SHARP_){
return (this$["cljsInputElement"] = p1__44596_SHARP_);
});})(G__44598,v,value,on_change))
);
...
var vec__44605 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__44605,(0),null);
var id = cljs.core.nth.call(null,vec__44605,(1),null);
var class$ = cljs.core.nth.call(null,vec__44605,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___44610 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___44610 == null)){
} else {
var key_44611 = temp__4661__auto___44610;
...
var G__44613 = (new reagent.impl.template.NativeWrapper());
(G__44613["name"] = c);
...
var len__27054__auto___44619 = arguments.length;
var i__27055__auto___44620 = (0);
while(true){
if((i__27055__auto___44620 < len__27054__auto___44619)){
args__27061__auto__.push((arguments[i__27055__auto___44620]));

var G__44621 = (i__27055__auto___44620 + (1));
i__27055__auto___44620 = G__44621;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__44618,seq44617__$1);
});
...
break;
default:
var G__44625 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__44625;
continue;
...
var n__26894__auto___44628 = a.length;
var i_44629 = (0);
while(true){
if((i_44629 < n__26894__auto___44628)){
(a[i_44629] = reagent.impl.template.as_element.call(null,(a[i_44629])));

var G__44630 = (i_44629 + (1));
i_44629 = G__44630;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26894__auto___44631 = a.length;
var i_44632 = (0);
while(true){
if((i_44632 < n__26894__auto___44631)){
var val_44633 = (a[i_44632]);
if((cljs.core.vector_QMARK_.call(null,val_44633)) && ((reagent.impl.template.key_from_vec.call(null,val_44633) == null))){
(o["no-key"] = true);
} else {
}

(a[i_44632] = reagent.impl.template.as_element.call(null,val_44633));

var G__44634 = (i_44632 + (1));
i_44632 = G__44634;
continue;
} else {
}
...
var ctx = ({});
var vec__44638 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__44638,(0),null);
var derefed = cljs.core.nth.call(null,vec__44638,(1),null);
...
var G__44642 = (cljs.core.count.call(null,argv) - first_child);
switch (G__44642) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__44642){
...
//# sourceMappingURL=template.js.map?rel=1497028410710