...
try{var o__37125__auto___54745 = t;
goog.object.get(o__37125__auto___54745,"cljs$lang$ctorPrWriter").call(o__37125__auto___54745,t,writer);
}catch (e54744){var __54746 = e54744;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__54748 = num_code;
switch (G__54748) {
case (1):
return (185);
...
}catch (e54754){var e__37150__auto__ = e54754;
return false;
}})())){
...
var vec__54755 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__54755,(0),null);
...
var len__27054__auto___54764 = arguments.length;
var i__27055__auto___54765 = (0);
while(true){
if((i__27055__auto___54765 < len__27054__auto___54764)){
args__27061__auto__.push((arguments[i__27055__auto___54765]));

var G__54766 = (i__27055__auto___54765 + (1));
i__27055__auto___54765 = G__54766;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__54760){
var vec__54761 = p__54760;
var ns_detector = cljs.core.nth.call(null,vec__54761,(0),null);
...
var G__54767 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__54768 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__54767;
remaining_tokens = G__54768;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq54758){
var G__54759 = cljs.core.first.call(null,seq54758);
var seq54758__$1 = cljs.core.next.call(null,seq54758);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__54759,seq54758__$1);
});
...
var vec__54776 = cljs.core.split_with.call(null,(function (p1__54772_SHARP_){
return cljs.core.not_EQ_.call(null,p1__54772_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__54776,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__54776,(1),null);
...
var vec__54782 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__54782,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__54782,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__54785 = cljs.core.rest.call(null,remaining_tokens);
var G__54786 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__54785;
name_tokens = G__54786;
continue;
} else {
...
var args54787 = [];
var len__27054__auto___54799 = arguments.length;
var i__27055__auto___54800 = (0);
while(true){
if((i__27055__auto___54800 < len__27054__auto___54799)){
args54787.push((arguments[i__27055__auto___54800]));

var G__54801 = (i__27055__auto___54800 + (1));
i__27055__auto___54800 = G__54801;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54787.length)].join('')));
...
var vec__54790 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__54790,(0),null);
var arity = cljs.core.nth.call(null,vec__54790,(1),null);
var vec__54793 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__54793,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__54793,(1),null);
var vec__54796 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__54796,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__54796,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__54796,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__54796,(3),null);
...
var args54803 = [];
var len__27054__auto___54809 = arguments.length;
var i__27055__auto___54810 = (0);
while(true){
if((i__27055__auto___54810 < len__27054__auto___54809)){
args54803.push((arguments[i__27055__auto___54810]));

var G__54811 = (i__27055__auto___54810 + (1));
i__27055__auto___54810 = G__54811;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54803.length)].join('')));
...
var vec__54806 = result;
var munged_ns = cljs.core.nth.call(null,vec__54806,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__54806,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__54806,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__54806,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__54806,(4),null);
var arity = cljs.core.nth.call(null,vec__54806,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__54819 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__54819,(0),null);
var args = cljs.core.nth.call(null,vec__54819,(1),null);
var vec__54822 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__54822,(0),null);
var name = cljs.core.nth.call(null,vec__54822,(1),null);
...
var G__54825 = (arity + (1));
var G__54826 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__54827){
var vec__54831 = p__54827;
var arity = cljs.core.nth.call(null,vec__54831,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__54831,(1),null);
...
return cljs.core.get.call(null,arities,p1__54834_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__54835_SHARP_){
return cljs.core.drop.call(null,(2),p1__54835_SHARP_);
...
var args__27061__auto__ = [];
var len__27054__auto___54842 = arguments.length;
var i__27055__auto___54843 = (0);
while(true){
if((i__27055__auto___54843 < len__27054__auto___54842)){
args__27061__auto__.push((arguments[i__27055__auto___54843]));

var G__54844 = (i__27055__auto___54843 + (1));
i__27055__auto___54843 = G__54844;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__54838){
var vec__54839 = p__54838;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__54839,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq54836){
var G__54837 = cljs.core.first.call(null,seq54836);
var seq54836__$1 = cljs.core.next.call(null,seq54836);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__54837,seq54836__$1);
});
...
var G__54846 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__54846) {
...
var map__54853 = options;
var map__54853__$1 = ((((!((map__54853 == null)))?((((map__54853.cljs$lang$protocol_mask$partition0$ & (64))) || (map__54853.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54853):map__54853);
var include_ns_QMARK_ = cljs.core.get.call(null,map__54853__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__54853__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__54853__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__54853__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__54854 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__54854,(0),null);
var fn_name = cljs.core.nth.call(null,vec__54854,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__54854,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__54854,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__54854,(4),null);
var arity = cljs.core.nth.call(null,vec__54854,(5),null);
...
}catch (e54859){var e__37150__auto__ = e54859;
...
var G__54860 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__54861 = cljs.core.rest.call(null,path);
obj = G__54860;
path = G__54861;
continue;
} else {
...
return (function (accum,p__54866){
var vec__54867 = p__54866;
var bit = cljs.core.nth.call(null,vec__54867,(0),null);
var protocol = cljs.core.nth.call(null,vec__54867,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__54870){
var vec__54874 = p__54870;
var ns = cljs.core.nth.call(null,vec__54874,(0),null);
var name = cljs.core.nth.call(null,vec__54874,(1),null);
var selector = cljs.core.nth.call(null,vec__54874,(2),null);
...
return (function (p__54882){
var vec__54883 = p__54882;
var munged_name = cljs.core.nth.call(null,vec__54883,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__54883,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__54883,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__54877_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__54877_SHARP_));
});})(name,sorted_matches,vec__54883,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1497028430764