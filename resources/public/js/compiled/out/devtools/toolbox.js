...
var args55391 = [];
var len__27054__auto___55397 = arguments.length;
var i__27055__auto___55398 = (0);
while(true){
if((i__27055__auto___55398 < len__27054__auto___55397)){
args55391.push((arguments[i__27055__auto___55398]));

var G__55399 = (i__27055__auto___55398 + (1));
i__27055__auto___55398 = G__55399;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args55391.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox55394 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox55394 = (function (obj,header,style,tag,meta55395){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox55394.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55396,meta55395__$1){
var self__ = this;
var _55396__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox55394(self__.obj,self__.header,self__.style,self__.tag,meta55395__$1));
});

devtools.toolbox.t_devtools$toolbox55394.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55396){
var self__ = this;
var _55396__$1 = this;
return self__.meta55395;
});

devtools.toolbox.t_devtools$toolbox55394.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox55394.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox55394.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox55394.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox55394.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta55395","meta55395",1301965120,null)], null);
});

devtools.toolbox.t_devtools$toolbox55394.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox55394.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox55394";

devtools.toolbox.t_devtools$toolbox55394.cljs$lang$ctorPrWriter = (function (this__26585__auto__,writer__26586__auto__,opt__26587__auto__){
return cljs.core._write.call(null,writer__26586__auto__,"devtools.toolbox/t_devtools$toolbox55394");
});

devtools.toolbox.__GT_t_devtools$toolbox55394 = (function devtools$toolbox$__GT_t_devtools$toolbox55394(obj__$1,header__$1,style__$1,tag__$1,meta55395){
return (new devtools.toolbox.t_devtools$toolbox55394(obj__$1,header__$1,style__$1,tag__$1,meta55395));
});

}

return (new devtools.toolbox.t_devtools$toolbox55394(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1497028432216