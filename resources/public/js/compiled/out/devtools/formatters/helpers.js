...
var G__54888 = devtools.prefs.pref.call(null,v);
v = G__54888;
continue;
} else {
return v;
...
}catch (e54901){var e__37150__auto__ = e54901;
return false;
}})();
...
}catch (e54905){var e__37150__auto__ = e54905;
return false;
}})();
...
}catch (e54907){var e__37150__auto__ = e54907;
return false;
}}
}
});
...
var vec__54912 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__54912,(0),null);
var name = cljs.core.nth.call(null,vec__54912,(1),null);
...
return cljs.core.some.call(null,(function (p1__54915_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__54915_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1497028430898