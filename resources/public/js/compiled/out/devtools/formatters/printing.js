...
var len__27054__auto___54931 = arguments.length;
var i__27055__auto___54932 = (0);
while(true){
if((i__27055__auto___54932 < len__27054__auto___54931)){
args__27061__auto__.push((arguments[i__27055__auto___54932]));

var G__54933 = (i__27055__auto___54932 + (1));
i__27055__auto___54932 = G__54933;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq54928){
var G__54929 = cljs.core.first.call(null,seq54928);
var seq54928__$1 = cljs.core.next.call(null,seq54928);
var G__54930 = cljs.core.first.call(null,seq54928__$1);
var seq54928__$2 = cljs.core.next.call(null,seq54928__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__54929,G__54930,seq54928__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__54934_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__54934_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__54943__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e54947){var e__37150__auto__ = e54947;
return false;
}})();
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
...
}catch (e54949){var e__37150__auto__ = e54949;
return false;
}}
})())){
...
var _STAR_current_state_STAR_54954 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__54955 = opts;
var map__54955__$1 = ((((!((map__54955 == null)))?((((map__54955.cljs$lang$protocol_mask$partition0$ & (64))) || (map__54955.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54955):map__54955);
var markup_db = cljs.core.get.call(null,map__54955__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_54954;
}});
...
;
var temp__4655__auto___54960 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___54960)){
var managed_print_level_54961 = temp__4655__auto___54960;
var _STAR_print_level_STAR_54959_54962 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_54961;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_54959_54962,managed_print_level_54961,temp__4655__auto___54960,writer,opts,job_fn){
return (function (p1__54957_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__54957_SHARP_,null);
});})(_STAR_print_level_STAR_54959_54962,managed_print_level_54961,temp__4655__auto___54960,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_54959_54962;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1497028431088