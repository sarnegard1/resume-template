...
var map__55679 = top_item;
var map__55679__$1 = ((((!((map__55679 == null)))?((((map__55679.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55679.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55679):map__55679);
var file = cljs.core.get.call(null,map__55679__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__55679__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__55679__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e55678){var _e = e55678;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___55681 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___55681)){
var seen_errors_55682 = temp__4655__auto___55681;
if(cljs.core.truth_(seen_errors_55682.has(self))){
} else {
seen_errors_55682.add(self);

var temp__4657__auto___55683 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___55683)){
var sense_55684 = temp__4657__auto___55683;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_55684)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1497028432761